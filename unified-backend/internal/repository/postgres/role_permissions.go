...
SELECT role,
    ...
    can_deactivate_own_links, can_deactivate_all_links,
    can_reactivate_own_links, can_reactivate_all_links,
...
func (r *RolePermissionsRepository) GetAll(ctx context.Context) ([]domain.RolePermissions, error) {
	...
	for rows.Next() {
		...
		if err := rows.Scan(
			...
			&p.CanDeactivateOwnLinks, &p.CanDeactivateAllLinks,
			&p.CanReactivateOwnLinks, &p.CanReactivateAllLinks,
...
ON CONFLICT (role) DO UPDATE SET
    ...
    can_deactivate_own_links          = EXCLUDED.can_deactivate_own_links,
    can_deactivate_all_links          = EXCLUDED.can_deactivate_all_links,
    can_reactivate_own_links          = EXCLUDED.can_reactivate_own_links,
    can_reactivate_all_links          = EXCLUDED.can_reactivate_all_links,
    can_delete_own_links_permanently  = EXCLUDED.can_delete_own_links_permanently,
    can_delete_all_links_permanently  = EXCLUDED.can_delete_all_links_permanently,
